...
- Treat the active repo path as the only code-writing location. If a user asks for a new branch or worktree, interpret that as a GitHub branch request only.
