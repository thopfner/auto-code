...
export const runtimeConfigSchema = z.object({
  ...
  OPENCLAW_SETUP_MODE: z.enum(["detect-existing", "install-or-onboard", "configure-later", "advanced-webhook"]).default("detect-existing"),
  OPENCLAW_AUTH_REF: secretRefSchema.optional(),
  OPENCLAW_TOKEN_REF: secretRefSchema.optional(),
