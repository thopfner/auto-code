...
Status: `PHASE_3_QA_CHECKPOINT`
Current authorized window: QA review for `30-phase-3-codex-forge-engine.md` revision
...
Phase 1 and Phase 2 are cleared. Phase 3 revision is stopped at QA checkpoint. Phase 4 must not start until QA clears the current checkpoint and returns a new handoff.
