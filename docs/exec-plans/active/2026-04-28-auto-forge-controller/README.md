...
Status: `PHASE_3_CLEARED`
Current authorized window: `40-phase-4-portability-ops.md` only
...
Phase 1, Phase 2, and Phase 3 are cleared. Only Phase 4 is authorized now. Later phases are context only until a QA pass clears the current checkpoint and returns a new handoff.
